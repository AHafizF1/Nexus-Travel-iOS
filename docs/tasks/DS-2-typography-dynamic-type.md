...
4. Record run URL plus first missing-symbol/compiler failure in PR body. Failure must be absent production contract, not bad YAML.
...
4. Push same branch; wait for latest-SHA `build-test` green.
