...
- [ ] RED CI failure observed and linked.
- [ ] GREEN latest-SHA build/test checks.
- [ ] App config contract tests cover origin, mobile base, health path.
- [ ] PARITY row complete and PROGRESS appended.
